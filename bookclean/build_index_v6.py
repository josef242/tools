#!/usr/bin/env python3
"""Build a per-book index of book.v6.jsonl: offset, length, region, title."""
import os, re, json
from multiprocessing import Pool

PATH = os.path.expanduser("~/data/book.v6.jsonl")
...
def main():
    ...
    all_rows.sort()
    with open('reports/book_index_v6.tsv','w') as out:
