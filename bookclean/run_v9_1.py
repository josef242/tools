...
DST = os.path.expanduser('~/data/book.v9.1.jsonl')
SHARDS = os.path.expanduser('~/data/.v9_1_shards')
...
def main():
    ...
    with open('reports/v9_1_ledger.jsonl','w') as L:
        for i in range(W):
