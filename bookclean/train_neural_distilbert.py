...
head = nn.Sequential(nn.Linear(768, 256), nn.ReLU(), nn.Dropout(0.1), nn.Linear(256, 1)).to(dev)
...
torch.save({'enc': enc.state_dict(), 'head': head.state_dict()}, 'reports/para_clf_distilbert.pt')
print("saved reports/para_clf_distilbert.pt")
