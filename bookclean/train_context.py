...
rows = json.load(open('reports/para_context_dataset.json'))
...
torch.save({'enc': enc.state_dict(), 'head': head.state_dict()}, 'reports/para_clf_context.pt')
print("saved reports/para_clf_context.pt")
