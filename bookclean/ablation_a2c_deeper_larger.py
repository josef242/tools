...
CONFIGS = [('res-16w384', resnet(16, 384)), ('res-24w384', resnet(24, 384)),
           ('res-32w384', resnet(32, 384)), ('res-16w768', resnet(16, 768)),
           ('res-24w768', resnet(24, 768)), ('res-48w384', resnet(48, 384))]
results = {}
...
json.dump(results, open('reports/ablation_a2c_deeper_larger.json','w'), indent=1)
